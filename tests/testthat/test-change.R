...
test_that("Characteristic change", {
  ...
  tmp <- fchange(
    X = dat, method = "characteristic", h = 0,
  ...
  ## Change
  set.seed(123)
  tmp <- fchange(electricity,
    method = "characteristic", h = 0,
  ...
  set.seed(123)
  tmp <- fchange(
    X = electricity, method = "characteristic", h = 0,
    statistic = "Tn", type = "Single",
    critical = "simulation",
    M = 200
  )
  ...
  # expect_equal(tmp$pvalue, 0)
  expect_error(change(electricity,
    method = "characteristic", h = 0,
    statistic = "Mn", type = "Single",
    critical = "welch",
    M = 200
...
test_that("Eigen change", {
  ...
  dat <- generate_brownian_bridge(100)
  tmp <- fchange(dat,
    method = "eigenjoint", h = 0, eigen_number = 1,
    statistic = "Tn",
    critical = "simulation",
    M = 200
  )
  ...
  tmp <- fchange(electricity,
    method = "eigensingle", h = 0, eigen_number = 1,
    statistic = "Mn",
    critical = "simulation",
    M = 1000
  )
